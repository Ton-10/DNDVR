...
namespace Skills
{
    public class AirBall : MonoBehaviour, ISkill
    {
        ...
        void Start()
        {
            BaseSkillInfo =
                new Skill(
                    skillPrefabs: new List<GameObject> { Resources.Load("Prefabs/AirBall") as GameObject },
                    user: gameObject,
                    rHand: GameObject.FindGameObjectWithTag("RightHand"),
                    lHand: GameObject.FindGameObjectWithTag("LeftHand"),
                    damageType: Helper.DamageType.Air,
